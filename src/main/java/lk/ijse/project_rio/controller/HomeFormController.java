...
public class HomeFormController implements Initializable {
    ...
    public void setDataToPieChart() throws SQLException {
        ObservableList<PieChart.Data> pieChartData = OrderModel.getDataToPieChart();
    ...
    public void setDataToBarChart() throws SQLException {
        ObservableList<XYChart.Series<String, Integer>> barChartData = InventoryModel.getDataToBarChart();
    ...
    public void setDataToAreaChart() throws SQLException {
        ...
        data = OrderModel.getDataToAreaChart(year);
